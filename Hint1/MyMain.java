...
public class MyMain {
	...
	public static void test(){
		...
		resI = ex.getNumAppearances(m1, 0); //0
		System.out.println(resI);
		
		resI = ex.getNumAppearances(m3, 6); //2
		System.out.println(resI);		
		
		resI = ex.getNumAppearances(m3, 5); //1
		System.out.println(resI); 		
		...
		resI = ex.n_toThePowerof_m(3, 5); //243
		System.out.println(resI);
		
		resI = ex.n_toThePowerof_m(2, 0); //1
		System.out.println(resI);		
		
		resI = ex.n_toThePowerof_m(5, 2); //25
		System.out.println(resI);
		...
		resI = ex.lucas(3);
		System.out.println(resI); //4
		
		resI = ex.lucas(15);
		System.out.println(resI); //1364
