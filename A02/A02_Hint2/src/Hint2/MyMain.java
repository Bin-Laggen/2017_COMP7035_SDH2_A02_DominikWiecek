...
public class MyMain {
	...
	public static void test(){
		...
		ex.recursiveDisplayElements(resM); //error
		
		resM = ex.smallerMyList(m2, 9);
		ex.recursiveDisplayElements(resM); //3,2
		
		resM = ex.smallerMyList(m3, 6);
		ex.recursiveDisplayElements(resM); //4,1,3,5,2
		...
		ex.recursiveDisplayElements(resM); //9
		
		resM = ex.biggerEqualMyList(m3, 6);
		ex.recursiveDisplayElements(resM); //8,6,6
		...
		ex.recursiveDisplayElements(resM); //2,3,9

		resM = ex.quickSort(m3);
		ex.recursiveDisplayElements(resM); //1,2,3,4,5,6,6,8
